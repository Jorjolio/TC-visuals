...
public class compiladorLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"INT", "FLOAT", "DOUBLE", "CHAR", "BOOL", "VOID", "MAIN", "IF", "ELSE", 
			"FOR", "WHILE", "RETURN", "TRUE", "FALSE", "ASSIGN", "PLUS", "MINUS", 
			"MULTIPLY", "DIVIDE", "MODULO", "INCREMENT", "DECREMENT", "EQUAL", "NOT_EQUAL", 
			"LESS_THAN", "LESS_EQUAL", "GREATER_THAN", "GREATER_EQUAL", "AND", "OR", 
			"NOT", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "SEMICOLON", "COMMA", 
			"IDENTIFIER", "NUMBER", "FLOAT_LITERAL", "CHAR_LITERAL", "STRING_LITERAL", 
